/*
  ...
  - You are about to drop the column `weight` on the `Submission` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "Assignment" ADD COLUMN "weight" REAL DEFAULT 1;
