...
CREATE TABLE "Section" (
    ...
    "name" TEXT,
    "classId" TEXT,
    CONSTRAINT "Section_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_Assignment" ("classId", "createdAt", "dueDate", "id", "instructions", "modifiedAt", "teacherId", "title") SELECT "classId", "createdAt", "dueDate", "id", "instructions", "modifiedAt", "teacherId", "title" FROM "Assignment";
