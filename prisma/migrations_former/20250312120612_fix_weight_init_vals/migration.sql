...
INSERT INTO "new_Assignment" ("classId", "createdAt", "dueDate", "graded", "id", "instructions", "maxGrade", "modifiedAt", "sectionId", "teacherId", "title", "weight") SELECT "classId", "createdAt", "dueDate", "graded", "id", "instructions", "maxGrade", "modifiedAt", "sectionId", "teacherId", "title", coalesce("weight", 1) AS "weight" FROM "Assignment";
