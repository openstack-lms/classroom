/*
  ...
  - You are about to drop the column `gradeMax` on the `Assignment` table. All the data in the column will be lost.
...
INSERT INTO "new_Assignment" ("classId", "createdAt", "dueDate", "graded", "id", "instructions", "modifiedAt", "sectionId", "teacherId", "title") SELECT "classId", "createdAt", "dueDate", "graded", "id", "instructions", "modifiedAt", "sectionId", "teacherId", "title" FROM "Assignment";
