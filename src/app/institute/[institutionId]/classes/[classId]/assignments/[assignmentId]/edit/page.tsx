...
export default function EditAssignmentPage({
  ...
  const updateAssignment = trpc.assignment.update.useMutation({
    onSuccess: () => {
      router.push(`/institute/${params.institutionId}/classes/${params.classId}/assignments/${params.assignmentId}`);
    },
  });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                name="graded"
                value="true"
                defaultChecked={assignment.graded}
            ...
            <div className="flex justify-end space-x-4">
              <Button.Light
                type="button"
                onClick={() => router.push(`/institute/${params.institutionId}/classes/${params.classId}/assignments/${params.assignmentId}`)}
              >
                Cancel
              </Button.Light>
              <Button.Primary type="submit" disabled={updateAssignment.isPending}>
