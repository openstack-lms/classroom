...
import { uploadFile, deleteFile, getSignedUrl } from '@/lib/googleCloudStorage';
 ...
 */
async function generateMediaThumbnail(fileBuffer: Buffer, fileType: string): Promise<Buffer> {
